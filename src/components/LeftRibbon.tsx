  ...
  return (
    <div className="left-ribbon">
      <div className="ribbon-top">
        ...
        <button className="ribbon-btn" onClick={onNewFolder} title="New folder">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button className="ribbon-btn" onClick={onOpenSearch} title="Quick search (Ctrl+P)">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="11" cy="11" r="8"/>
            <path d="m21 21-4.3-4.3"/>
          </svg>
        </button>
        <button className="ribbon-btn" onClick={onDailyNote} title="Daily note (Ctrl+Shift+N)">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="ribbon-bottom">
        <button className={`ribbon-btn ${activePanel === "graph" ? "active" : ""}`} onClick={onOpenGraph} title="Graph view">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button className={`ribbon-btn ${activePanel === "templates" ? "active" : ""}`} onClick={onOpenTemplates} title="Templates">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
